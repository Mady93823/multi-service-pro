...
// Moved to Tests\Support\SettingsFixtures (M13) so other suites can reuse it
// without duplicating the landmine-13 payload. Kept as a wrapper here.
function validSettingsPayload(array $overrides = []): array
{
    return SettingsFixtures::validPayload($overrides);
}
