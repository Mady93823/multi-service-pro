...
import { AlertTriangle, CreditCard, LoaderCircle, Timer, Wallet } from 'lucide-react';
...
export default function PayPage({ booking, methods, expires_at: expiresAt }: PayPageProps) {
    const t = useTrans();
            ...
            <div className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-4 p-4">
                ...
                <Card>
                    ...
                    <CardContent className="space-y-3">
                        ...
                        {methods.gateways.length === 0 && !methods.wallet.enabled && (
