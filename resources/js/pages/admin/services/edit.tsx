...
export default function EditService({ service, categories, relatable, zones }: EditServiceProps) {
    const t = useTrans();
    ...
    return (
        <AdminLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 p-4">
                ...
                <ServiceForm categories={categories} relatable={relatable} zones={zones} service={service} />
            </div>
        </AdminLayout>
    );
}
